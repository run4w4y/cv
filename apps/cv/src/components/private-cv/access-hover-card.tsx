  ...
  return (
    <span className="group/private-access relative inline-flex max-w-full align-baseline">
      ...
      <span
        ...
        role="tooltip"
      >
        <span className="block border border-border bg-popover/80 p-4 font-sans font-normal text-popover-foreground not-italic shadow-[2px_2px_0_var(--border)] backdrop-blur-sm">
          <span
          ...
          <span
            className="mt-3 block border-t border-border pt-3 font-mono text-xs/5 whitespace-normal break-words text-muted-foreground"
