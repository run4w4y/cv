...
/**
 * Measures the renderer-owned document without inspecting any CV fields.
 *
 * The function deliberately has no module-level runtime dependencies so it can
 * also be serialized by Puppeteer's `page.evaluate` in Browser Rendering.
 */
export const measureCvPageLayoutInDocument = (
  ...
  documentValue.documentElement.append(pageProbe)
