  ...
  group "dispatcher" {
    ...
    task "pdf-dispatcher" {
      ...
      env {
        ...
        PDF_DISPATCH_BATCH_SIZE      = [[ .my.batch_size | quote ]]
      ...
      template {
        data = <<EOH
{{ with secret "secret/data/cv-pdf-dispatcher/postgres-credentials" -}}
...
EOH
      ...
      template {
        data = <<EOH
{{ with secret "secret/data/cv-pdf-dispatcher/nats-credentials" -}}
