...
CREATE INDEX "pdf_generation_outbox_pending_idx" ON "pdf_generation_outbox" ("dispatched_at","created_at");--> statement-breakpoint
...
ALTER TABLE "idempotency_receipts" ADD CONSTRAINT "idempotency_receipts_application_id_applications_id_fkey" FOREIGN KEY ("application_id") REFERENCES "applications"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "pdf_generation_outbox" ADD CONSTRAINT "pdf_generation_outbox_artifact_id_generated_artifacts_id_fkey" FOREIGN KEY ("artifact_id") REFERENCES "generated_artifacts"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "pdf_generation_outbox" ADD CONSTRAINT "pdf_generation_outbox_application_id_applications_id_fkey" FOREIGN KEY ("application_id") REFERENCES "applications"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "pdf_generation_outbox" ADD CONSTRAINT "pdf_generation_outbox_content_entry_id_content_entries_id_fkey" FOREIGN KEY ("content_entry_id") REFERENCES "content_entries"("id") ON DELETE CASCADE;