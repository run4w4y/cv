...
INSERT INTO `__new_cv_links` (`id`, `application_id`, `content_entry_id`, `published_revision_id`, `token`, `public_url`, `enabled`, `disabled_reason`, `disabled_at`, `publication_version`, `version`, `created_at`, `updated_at`)
SELECT `id`, `application_id`, `content_entry_id`, `published_revision_id`, `token`, `public_url`, `enabled`, `disabled_reason`, `disabled_at`, `version`, `version`, `created_at`, `updated_at` FROM `cv_links`;--> statement-breakpoint
